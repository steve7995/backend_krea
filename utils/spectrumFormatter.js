...
export const sendToSpectrum = async (sessionId, spectrumData) => {
  try {
    const SPECTRUM_URL = `https://sandbox.cardihab-api.healthkon.com/api/patients/cardiac-rehab-session/${spectrumData.patient_id}`;
...
export const notifySpectrumTokenExpired = async (patientId, sessionId = null) => {
  try {
    const SPECTRUM_URL = `https://sandbox.cardihab-api.healthkon.com/api/patients/token-expired/${patientId}`;
...
export const pushHistoricalHRToSpectrum = async (patientId, processedData) => {
  try {
    const SPECTRUM_URL = `https://sandbox.cardihab-api.healthkon.com/api/patients/rehab-historical-hr/${patientId}`;
...
export const pushRestingHRToSpectrum = async (patientId, restingHR) => {
  try {
    const SPECTRUM_URL = `https://sandbox.cardihab-api.healthkon.com/api/patients/rehab-resting-hr/${patientId}`;
